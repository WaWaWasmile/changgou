...
public class ParaController {
   ...
   public Result<List<Para>> findByCategory(@PathVariable(value = "id") Integer id){
       List<Para> paras = paraService.findParaByCategory(id);
       return new Result<List<Para>> (true,StatusCode.OK,"根据分类查询参数信息",paras);
   }
    /**
     * 查询全部数据
     * @return
